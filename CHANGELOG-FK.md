...
- Made brainstorming decision-driven instead of mandatory.
- Replaced absolute TDD with risk-based red-green-refactor and explicit alternative verification.
- Added hard multi-agent entry limits and circuit breakers.
